      ...
      <div className={styles.container}>
        <div className='p-12 mr-12 ml-12'>
          ...
          <p className='flex justify-center'>
            The cryptography that secures blockchains like Bitcoin and Ethereum are impenetrable. 
          ...
          <p className='flex justify-center'>
            ...
            Unfortunately, there have been numerous widely-circulated articles claiming that a Bitcoin transaction requires a wildly large amount of electricity; most of these claims cited a source that had very little understanding of the protocol itself.
            ...
            You'll find misinformation about the energy consumption of Proof of Work algorithms all over the internet, but ultimately these concerns are more or less based on fact.
            ...
            This is one reason why Ethereum has chosen to end its reliance on PoW in favor of another consensus mechanism that will drop Ethereum's carbon footprint by 99% while simultaneously improving decentralization by removing the barrier of entry to validating the network: Proof of Stake.
          </p>
          <div className='justify-center text-4xl mt-12 mb-10'>
            <h1 className='flex justify-center'>
